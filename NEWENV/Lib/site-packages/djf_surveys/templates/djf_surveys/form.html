...
{% block content %}
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-lg mx-auto">
            <div style="background-color: #f2f2f2; padding: 20px; text-align: center; border: 1px solid #ddd; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">

                <img src="{% static 'djf_surveys/images/KDC-Logo.png' %}" style="max-width: 100px; height: auto; display: block; margin: auto;" alt="">
                <h1 class="text-2xl font-bold text-center text-green-800 sm:text-3xl">{{ title_page|default:"friend" }}</h1>
