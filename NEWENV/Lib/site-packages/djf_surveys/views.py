...
def thank_you(request):
    return render(request, 'djf_surveys/thank_you.html')


def success_note(request):
    response_content = "Form Submission Successfull!"
...
class CreateSurveyFormView(ContextTitleMixin, SurveyFormView):
    ...
    success_url = reverse_lazy("djf_surveys:thank_you")
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if not request.user.is_authenticated and not survey.can_anonymous_user:
            ...
            # return redirect("djf_surveys:thank_you")
